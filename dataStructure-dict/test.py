...
def calculate_subtotal(order):
    ...
    print('The subtotal of the items selected: $', str(subtotal))
...
def calculate_tax(subtotal):
    ...
    ### WRITE SOLUTION HERE
    tax_of_subtotal = round(subtotal * 0.15,2)
    print('The tax is: $', str(tax_of_subtotal))
    return tax_of_subtotal
    raise NotImplementedError()
